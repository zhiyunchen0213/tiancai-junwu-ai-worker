...
# ============ 配置区 ============
# REVIEW_SERVER_URL 走 autossh 反向隧道的本地转发端口 (-L 13000:localhost:3000),
# 不走公网 — 隧道断了 worker 自动报错而不是走错路径打 stale 老机.
# 2026-05-17 VPS 迁移后该值跟 IP 解耦, 不再需要硬编码新 VPS IP.
REVIEW_SERVER_URL="http://127.0.0.1:13000"
